        <?php
            ...
            function editar($dados){
                ...
                $sql = "UPDATE cad_Produto SET nome_produto='$nome', fornecedor='$fornecedor', custo_produto='$custo', valor_venda='$valor', quantidade='$qntd', codigo_barra='$codigoBarra' WHERE id=$id";
                $query = $mysqli->query($sql);
